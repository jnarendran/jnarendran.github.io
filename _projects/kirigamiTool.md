...
image: assets/projectPhotos/gripperActuated.jpg
imagealt: a rack-and-pinion based double lever tool actuating a curved sheet with cuts
showcase: 1
---
...
<div style="display:flex; justify-content:center;">
  <video autoplay muted loop playsinline controls playsinline style="max-width: 75%; height: auto;">
    <source src="/assets/projectPhotos/kgVidCrop_c.m4v" type="video/mp4">
...
- 6X increase in load capacity (300+ grams) by reinforcing areas of greatest deformation
- 8X increase in fatigue life (80,000+ cycles) by reinforcing areas of high stress concentration
...
<p align="middle">
  A CAD model of the grasping tool (left) and the complete kirigami gripper assembly. 
</p>
